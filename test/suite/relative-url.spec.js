...
describe("relativeUrl()", () => {
  it("should support resolving from absolute URLs with the same origin", () => {
    expect(
      relativeUrl("https://iconduit.github.io/", "https://iconduit.github.io/"),
    ).toBe(".");
    expect(
      relativeUrl("https://iconduit.github.io", "https://iconduit.github.io/"),
    ).toBe(".");
    ...
    expect(
      relativeUrl(
        "https://iconduit.github.io/p/a/t/h",
        "https://iconduit.github.io/p/a/t/h",
      ),
    ).toBe("h");
    expect(
  ...
  it("should support resolving from absolute URLs with a different origin", () => {
    expect(
      relativeUrl("https://example.org/", "https://iconduit.github.io/p/a/t/h"),
    ).toBe("https://iconduit.github.io/p/a/t/h");
  });

  it("should support resolving from absolute URLs to already relative URLs", () => {
    expect(relativeUrl("https://iconduit.github.io/p/a/t/h", "x/y")).toBe(
      "x/y",
    );
    expect(relativeUrl("https://iconduit.github.io/p/a/t/h", "/x/y")).toBe(
      "/x/y",
