...
describe("renderTag()", () => {
  ...
  it("should support number attributes", () => {
    ...
    expect(renderTag(data)).toBe(
      '<tag-a attribute-a="111" attribute-b="1.11" attribute-c="0"></tag-a>',
    );
  });
  ...
  it("should support multiple attributes", () => {
    ...
    expect(renderTag(data)).toBe(
      '<tag-a attribute-a="value-a" attribute-b></tag-a>',
    );
  });
  ...
  it("should support reused sub-definitions", () => {
    ...
    expect(renderTag(data)).toBe(
      "<tag-a><tag-b><tag-c></tag-c></tag-b><tag-b><tag-c></tag-c></tag-b></tag-a>",
    );
  });
  ...
  it("should support mixing child types", () => {
    ...
    expect(renderTag(data)).toBe(
      "<tag-a>value-a<tag-b></tag-b><tag-c>111</tag-a>",
    );
  });
