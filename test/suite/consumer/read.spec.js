...
describe('readConsumer()', () => {
  describe('when the manifest is located directly in the output directory', () => {
    ...
    it('should produce the correct absolute path for document outputs', () => {
      expect(consumer.absoluteDocumentPath('documentA')).toBe(join(fixtureDirPath, 'document-a.html'))
    })
    ...
    it('should produce the correct absolute path for image outputs', () => {
      expect(consumer.absoluteImagePath('imageA', 'sizeA')).toBe(join(fixtureDirPath, 'image-a_size-a.png'))
    })
    ...
    it('should produce the correct absolute URL for image outputs', () => {
      expect(consumer.absoluteImageUrl('imageA', 'sizeA')).toBe('https://iconduit.github.io/image-a_size-a.png')
    })
  ...
  describe('when the manifest is located ouside the output directory', () => {
    ...
    it('should produce the correct absolute path for document outputs', () => {
      expect(consumer.absoluteDocumentPath('documentA')).toBe(join(fixtureDirPath, 'subdir/document-a.html'))
    })
    ...
    it('should produce the correct absolute path for image outputs', () => {
      expect(consumer.absoluteImagePath('imageA', 'sizeA')).toBe(join(fixtureDirPath, 'subdir/image-a_size-a.png'))
    })
