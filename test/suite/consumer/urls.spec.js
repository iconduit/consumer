...
describe("Consumer URL methods", () => {
  ...
  describe("with absolute base URL and output URL of .", () => {
    ...
    it("should be able to resolve absolute URLs", () => {
      expect(consumer.absoluteUrl(".")).toBe(
        "https://iconduit.github.io/p/a/t/",
      );
      expect(consumer.absoluteUrl("..")).toBe(
        "https://iconduit.github.io/p/a/",
      );
      expect(consumer.absoluteUrl("../x")).toBe(
        "https://iconduit.github.io/p/a/x",
      );
      expect(consumer.absoluteUrl("x/y")).toBe(
        "https://iconduit.github.io/p/a/t/x/y",
      );
      expect(consumer.absoluteUrl("x/y/")).toBe(
        "https://iconduit.github.io/p/a/t/x/y/",
      );
      expect(consumer.absoluteUrl("https://example.org/x/y")).toBe(
        "https://example.org/x/y",
      );
      expect(consumer.absoluteUrl("iconduit://dashboard")).toBe(
        "iconduit://dashboard",
      );
    });
    ...
    it("should be able to resolve relative URLs", () => {
      ...
      expect(consumer.url("https://example.org/x/y")).toBe(
        "https://example.org/x/y",
      );
    });
    ...
    it("should be able to resolve absolute image URLs", () => {
      ...
      expect(consumer.absoluteImageUrl("imageA", "absolute")).toBe(
        "https://example.org/x/y.png",
      );
      expect(consumer.absoluteImageUrl("imageA", "relative")).toBe(
        "https://iconduit.github.io/p/a/x/y.png",
      );
      expect(consumer.absoluteImageUrl("imageA", "nonexistent")).toBeNull();
      expect(
        consumer.absoluteImageUrl("nonexistent", "nonexistent"),
      ).toBeNull();
    });
    ...
    it("should be able to resolve relative image URLs", () => {
      ...
      expect(consumer.imageUrl("imageA", "absolute")).toBe(
        "https://example.org/x/y.png",
      );
    ...
    it("should be able to resolve absolute document URLs", () => {
      manifest.output.document.absolute = {
        url: "https://example.org/x/y.html",
      };
      manifest.output.document.relative = { url: "../x/y.html" };

      expect(consumer.absoluteDocumentUrl("absolute")).toBe(
        "https://example.org/x/y.html",
      );
      expect(consumer.absoluteDocumentUrl("relative")).toBe(
        "https://iconduit.github.io/p/a/x/y.html",
      );
    ...
    it("should be able to resolve relative document URLs", () => {
      ...
      expect(consumer.documentUrl("absolute")).toBe(
        "https://example.org/x/y.html",
      );
